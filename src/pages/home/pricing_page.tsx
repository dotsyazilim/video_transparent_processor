...
import PricingCalculator from '../../components/pricing/PricingCalculator/pricingCalculator';
import { useTranslation } from '../../i18n/LanguageProvider';
import '../../styles/pages/home/pricing-page.css';
  ...
  return (
    <div className="pricing-page">
      <section className="pricing-page__intro">
        ...
        <h1>{t('pricingPage.title', 'Choose compression, API, and infrastructure that scale with you')}</h1>
        <p>
          {t(
            'pricingPage.subtitle',
            'Start with unlimited web compression, then layer in API calls, managed storage, or dedicated servers as your workloads grow.',
          )}
        </p>
      </section>
      ...
      <section className="pricing-page__contact">
        ...
        <a className="primary" href="/contact">
          {t('pricingPage.contactCta', 'Satış ekibiyle görüş')}
        </a>
      </section>
    </div>
  );
