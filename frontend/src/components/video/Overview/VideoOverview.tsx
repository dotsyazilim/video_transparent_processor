...
import './styles/video-overview.css';
  ...
  return (
    <div className="video-overview">
      <section className="video-overview__hero">
        <p className="eyebrow">{t('videoPage.eyebrow', 'Video compression')}</p>
        <h1>{t('videoPage.title', 'Smarter transparent video compression')}</h1>
        <p>{t('videoPage.subtitle', 'Optimise frame-by-frame with presets designed for alpha-sensitive footage.')}</p>
        <div className="video-overview__actions">
          <a className="primary" href="#upload">
            {t('videoPage.primaryAction', 'Start compressing')}
          </a>
          <a className="ghost" href="#docs">
            {t('videoPage.secondaryAction', 'Read workflow guide')}
          </a>
        </div>
      </section>
